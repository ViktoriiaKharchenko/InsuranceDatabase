...
$(document).ready(()=>{
    ...
    if (slideNum == slideCount || slideNum <= 0 || slideNum > slideCount) {
        ...
        $('#images').css({'transform': 'translate(' + translateWidth + 'px, 0)','-webkit-transform': 'translate(' + translateWidth + 'px, 0)','-ms-transform': 'translate(' + translateWidth + 'px, 0)',
        });
